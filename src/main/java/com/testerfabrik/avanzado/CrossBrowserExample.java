...
public class CrossBrowserExample {
    ...
    String actual = null;
    //Para esperar por algun objeto
    WebDriverWait wait;

    //Creamos un metodo donde vamos a colocar las propiedades de los navegadores
    ...
    @BeforeTest
    @Parameters("browser") //Parametro que se va a esperar
